    ...
    <section className="pt-32 pb-24 bg-background">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-xs uppercase tracking-widest text-foreground/50 hover:text-accent font-medium mb-10 transition-colors duration-300 group"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start pb-20 border-b border-border-custom/50">
          ...
          <div className="lg:col-span-6 flex flex-col space-y-8">
            ...
            <div className="space-y-3">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl tracking-tight text-foreground leading-[1.12]">
                {product.title}
              </h1>
            ...
            {product.customizable && (
              <div className="bg-accent-secondary/5 border border-accent-secondary/10 rounded-2xl p-5 flex items-start gap-4">
            ...
            <div className="space-y-3 font-sans">
              <h3 className="text-xs uppercase tracking-widest font-semibold text-foreground/60">Story & Details</h3>
            ...
            <div className="space-y-4 pt-4 border-t border-border-custom/50">
              <h3 className="text-xs uppercase tracking-widest font-semibold text-foreground/80">Specifications</h3>
            ...
            {/* Large WhatsApp Order CTA */}
            <div className="pt-6 space-y-4">
              <a
                href={whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-3 py-5 rounded-full bg-accent hover:bg-accent/90 text-white font-medium uppercase tracking-widest text-xs transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-0.5"
              >
